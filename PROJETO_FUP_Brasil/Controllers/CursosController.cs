...
namespace PROJETO_FUP_Brasil.Controllers
{
    public class CursosController : Controller
    {
        ...
        {
            var pROJETO_FUP_BrasilContext = _context.Cursos.Include(c => c.Aluno);
        ...
        {
            ViewData["AlunoID"] = new SelectList(_context.Aluno, "Id_Matricula", "Nome");
            return View();
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id_Curso,NomeCurso,ValorCurso,ProfessorCurso,AlunoID")] Cursos cursos)
        {
